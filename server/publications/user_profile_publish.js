  ...
  return {
    ...
    children: [{
      ...
      children: [{
        ...
        find: function(feedback, profile){
          return ProfileImg.find({ userId: feedback.postBy }, { limit: 1 });
        }
      }]
    },{
      find: function(profile){
        return ProfileImg.find({ userId: profile.profID }, { limit: 1 });
      }
    }]
  }
});
  ...
  return {
    ...
    children: [{
      ...
      children: [{
        ...
        find: function(listing, profile) {
          return Uploads.find({ listID: listing._id },{ limit: 1 });
        }
      }]
    }]
  }
